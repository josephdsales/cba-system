...
$st = db()->prepare("SELECT e.*, u.fullname AS teacher_name,
    ...
    WHERE e.status='published' AND (e.section_id IS NULL OR e.section_id=?)
    ORDER BY e.created_at DESC");
$st->execute([$user['id'], $user['section_id']]);
$exams = $st->fetchAll();
...
<div class="card"><div class="table-wrap"><table>
  ...
  <tr>
    ...
    <td><?php if ($x['done_id']): ?><span class="badge b-published">Taken ✓</span> <a class="btn small ghost" href="student_scores.php">View score</a>
